...
def save_last_model_and_optimizer_sharded(model, rank, cfg,optim=None):
...
def save_model_last_checkpoint(
    model,
    optimizer,
    rank,
    cfg,
...
def save_optimizer_last_checkpoint(model, optimizer, rank, cfg, epoch=1):
    """save optimizer state via full state dict"""
